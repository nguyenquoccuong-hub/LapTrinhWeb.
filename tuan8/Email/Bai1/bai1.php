<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $matkhau = 'ussnlzquuaykwunt';// mật khẩu của tài khoản cuongnq.24itb@vku.udn.vn
		    $tennguoigui = 'Sư phụ của mày đây';
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                $mail->Port = 465;  // port to connect to                
                $mail->setFrom($nguoigui, $tennguoigui ); 
                $to = "nguyenquoccuong18032006@gmail.com";
                $to_name = "Đồ đệ";
    ...
    $email_array = explode(",",$recipients);*/
                ...
                $noidungthu = "<b>Chào đồ đệ, ta là cuongnq.24itb@vku.udn.vn!</b><br>Hãy rep lại gmail của ta" ;
